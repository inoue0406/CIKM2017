...
# ---------------------------------
# (2) prediction
file <- h5file("processed/for_python/radar_testB_3d_ds3.hdf5")
...
write.table(dout,sprintf("res/ranger/rf_result_testB_0628b_mt%d_nd%d.csv",mt,nd),
